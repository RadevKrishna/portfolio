import {
  ...
  usePaneLayout,
  useStructureTool
} from "./chunk-5G4R2ZF6.js";
import "./chunk-N67PM5KI.js";
import {
  Button,
  ErrorBoundary,
  NEVER,
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-5MGHWYBF.js")),
  document: (0, import_react.lazy)(() => import("./pane-E42N56ID.js").then(function(n) {
    return n.pane;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-E42N56ID.js").then(function(n) {
    return n.pane$1;
  })),
  list: (0, import_react.lazy)(() => import("./index2-HE5ILLVE.js"))
};
...
//# sourceMappingURL=index3-GQC5PEGN.js.map
